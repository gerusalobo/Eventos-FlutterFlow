...
class _ImagemWidgetState extends State<ImagemWidget> {
  ...
  void initState() {
    ...
    _model.urlImagem2TextController ??= TextEditingController();
    _model.urlImagem2FocusNode ??= FocusNode();
  }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        width: 400.0,
                        child: TextFormField(
                          controller: _model.urlImagem2TextController,
                          focusNode: _model.urlImagem2FocusNode,
                          autofocus: false,
                          obscureText: false,
                          ...
                          validator: _model.urlImagem2TextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    Padding(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.network(
                          _model.urlImagem2TextController.text,
                          width: 200.0,
                          height: 200.0,
                          fit: BoxFit.contain,
                        ),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await widget.umEvento!.reference
                          ...
                          name: widget.umEvento?.name,
                          image: _model.urlImagem2TextController.text,
                          local: widget.umEvento?.local,
                          data: widget.umEvento?.data,
                        ));
                        safeSetState(() {
                          _model.urlImagem2TextController?.clear();
                        });
